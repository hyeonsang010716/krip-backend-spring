...
/**
 * 게시글 좋아요 RDB 접근. 좋아요 목록 키셋 페이지네이션은 {@link TripmatePostLikeRepositoryCustom} 참고.
 */
public interface TripmatePostLikeRepository extends JpaRepository<TripmatePostLike, TripmatePostLikeId>, TripmatePostLikeRepositoryCustom {
